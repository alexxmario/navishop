...
// ─── Target model ───────────────────────────────────────────────────────────
const TARGET = { name: 'LT3', yearFrom: 2006, yearTo: 2016, skuPrefix: 'LT3' };
...
function replaceModelRefs(text, target) {
  ...
  // Replace "Crafter 2006-2016" (with various separators) with target
...
async function main() {
  ...
  console.log('=== VW Crafter 2006-2016 → LT3 2006-2016 Duplication ===');
